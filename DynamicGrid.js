...
var cloathingItems=document.getElementById("cloathing");
var assesoriesItems=document.getElementById("assesories");
...
name1.innerText=currentProduct.name;
name1.style.textOverflow="ellipses";
name1.style.listStylePosition="inside";
name1.style.fontWeight="400";
name1.style.fontSize="16px";
name1.style.fontWeight="bold";
name1.style.paddingLeft="10px";
...
price.innerText=`RS ${currentProduct.price}`;
price.style.color="green";
price.style.margin="10px";
price.style.fontWeight="bold";
div.append(img,name1,brand,price);
div.appendChild(a);
if(currentProduct.isAccessory){
  assesoriesItems.appendChild(div);
}
else{
  cloathingItems.appendChild(div);
}
